...
export const openSourceContributions: readonly OpenSourceContribution[] = [
  ...
  },
  {
    ...
    proof: "Merged after maintainer-requested fixes and green browser CI",
  ...
  },
  {
    ...
    proof: "Merged after maintainer review and repository validation",
  ...
  },
  {
    ...
    proof: "Open; contribution requirements and CLA checks complete",
  ...
  },
  {
    ...
    proof: "Open; accessibility implementation awaiting maintainer review",

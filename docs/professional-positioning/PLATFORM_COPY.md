...
### Open-Source Software Contributor — Independent
...
- Completed varied AI-training work under detailed and changing evaluation criteria.
- Applied independent written reasoning, careful guideline interpretation, and consistent quality control in a remote environment.

### Computer Repair Technician — Local Computer Repair Shop

2024 · Six months

- Diagnosed operating-system, application, and hardware failures on personal computers.
- Completed software repairs, component replacements, and preventive maintenance.
- Explained technical problems and practical solutions clearly to customers.

## LinkedIn Projects

### Relay — Webhook Delivery Platform

Built and deployed a TypeScript webhook delivery system on Cloudflare Workers, D1, and Queues with durable scheduling, signed requests, idempotent ingestion, deterministic retries, lease recovery, encrypted endpoint secrets, replay lineage, and inspectable failure evidence.

URL: https://github.com/XonkelX/relay-webhook-delivery

### Next — Real-Time Queue System

Built synchronized customer, staff, and public-display workflows with Next.js, Supabase Realtime, PostgreSQL RLS, transactional commands, idempotency receipts, and authoritative snapshot recovery.

URL: https://github.com/XonkelX/next-queue

## LinkedIn Featured order

1. Reticle PR #278: https://github.com/reticlehq/reticle/pull/278
